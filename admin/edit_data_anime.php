...
//AMBIL DATA YG DIKLIK EDIT DI HALAMAN data_anime_shounen.php TADI 
$id_alternatif = $_GET['id_alternatif'];

//TAMPILKAN DATA DIMANA id_alternatif nya ADALAH $id_alternatif
$data_anime = tampilanime("SELECT * FROM alternatif WHERE id_alternatif = '$id_alternatif' ")[0];

//JIKA DIKLIK BUTTON EDIT MAKA
if (isset($_POST['edit'])) {
  //JIKA function edit_anime > 0 (sukses) MAKA JALANKAN FUNGSI
  if (edit_anime($_POST) > 0) {
    echo "<script>
...
<body bgcolor="f0f0f0">
  ...
  <div class="container bg-light shadow p-3 mb-5">
    <div class="alert alert-info">
      <center><b>EDIT DATA ANIME SHOUNEN</b></center>
    </div>
      ...
      <form method="post" class="form-group">
        <table class="table">
          ...
          <tr>
            ...
            <td> : </td>
            <td width="500"><input type="text" name="id_alternatif" value="<?= $data_anime['id_alternatif']; ?>" readonly class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Nama Kriteria</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="nama_alternatif" value="<?= $data_anime['nama_alternatif']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Popularitas (C1)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="c1" value="<?= $data_anime['c1']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Alur Cerita (C2)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="c2" value="<?= $data_anime['c2']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Grafik (C3)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="c3" value="<?= $data_anime['c3']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Plot Hole (C4)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="c4" value="<?= $data_anime['c4']; ?>" class="form-control" autocomplete="off"></td>
          </tr>
          ...
          <td><button type="submit" name="edit" class="btn btn-warning">Edit </button> &nbsp;&nbsp;&nbsp;
            <a href="data_anime_shounen.php" class="btn btn-danger">Batal</a>
          </td>
          </tr>
        </table>
