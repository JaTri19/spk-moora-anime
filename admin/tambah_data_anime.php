...
if (isset($_POST['simpan'])) {
  //JIKA function tambah_anime > 0 (sukses) MAKA JALANKAN FUNGSI
  if (tambah_anime($_POST) > 0) {
    //DAN TAMPILKAN POP UP "DATA BERHASIL DI TAMBAH DAN LEMPAR KE HALAMAN data_anime_sport.php"
    echo "<script>
...
<body bgcolor="f0f0f0">
  ...
  <div class="container bg-light shadow p-3 mb-5">
    <div class="alert alert-info">
      <center><b>TAMBAH DATA ANIME SHOUNEN</b></center>
    </div>
